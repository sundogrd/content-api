...
type ContentStatus int16

const (
	ContentStatusDraft     ContentStatus = 1
	ContentStatusChecking  ContentStatus = 9
	ContentStatusPublished ContentStatus = 10
)
...
type SDContent struct {
	...
	Status      ContentStatus `gorm:"type:TEXT;NOT NULL;DEFAULT:10"`
